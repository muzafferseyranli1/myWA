 ...
 return <div className="flex h-dvh min-h-0 flex-col overflow-hidden bg-white text-[#111b21]">
  ...
  <div className="flex min-h-0 flex-1">
   <nav className="hidden w-[64px] shrink-0 flex-col items-center gap-5 border-r border-[#e9edef] bg-[#f0f2f5] py-5 sm:flex">
    ...
    {view==='chat'?<>
     <aside className={'shrink-0 border-r border-[#e9edef] '+(showTasks ? 'hidden' : (selected?'hidden md:block md:w-[340px] lg:w-[380px] xl:w-[420px]':'w-full md:block md:w-[340px] lg:w-[380px] xl:w-[420px]'))}><ChatList chats={chats} selectedChatId={selected} onSelectChat={selectChat} myJid={myJid} onMarkAllRead={markAllChatsAsRead}/></aside>
